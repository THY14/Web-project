...
const Home = () => {
  return (
    <div className='overflow-x-hidden overflow-y-scroll' >
      <Navbar />
      <Slide />
      <div className='lg:ml-[30%]  lg:w-3/4 lg:flex flex-col '>
        <h1 className='font-bold text-xl font-sans flex justify-center lg:-ml-[45%] lg:mt-10'>POPULAR GAMES</h1>
        <div className='grid grid-cols-3 grid-rows-2 gap-4 mt-[5%] ml-[4%] lg:ml-[-4%] lg:w-3/4 lg:gap-y-16'>
